...
<script type="text/javascript">
	...
	if (beInserted == 'true') { //삽입후에 페이지를 여는 것이다.
...
<body>
	...
	<div class="wrap">
		<table border="1">
			...
			<tfoot>
				<tr>
					<td colspan="4"><input type="button" value="새글작성하기"
						onclick="location.href='insertPage'"> <!--  onclick="location.href='insertPage'" 는 @RequestMapping("insertPage")을의미한다. -->
					</td>
				</tr>
			</tfoot>
		</table>
